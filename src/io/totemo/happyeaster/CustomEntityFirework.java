...
// ----------------------------------------------------------------------------
/**
 * NMS code to spawn an immediate firework explosion without the launch sound.
 *
 * Bukkit API (Firework.detonate()) is unsatisfactory for this purpose because
 * it does not allow the launch sound to be suppressed.
 *
 * From:
 * https://bukkit.org/threads/lib-instant-fireworks-no-launch-sound-no-visible
 * -rocket-just-the-firework-effect.269919/
 */
